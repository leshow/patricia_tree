...
//!
//! A common prefixes of the keys in a patricia tree are represented by a shared
//! path. So if the prefixes of the key set is highly redundant,
//! the memory usage of the resulting patricia tree will be drastically less
//! than more generic data structures (e.g., `BTreeMap`).
//!
